...
var Canvas = /** @class */ (function (_super) {
    ...
    function Canvas(cfg) {
        var _this = _super.call(this, tslib_1.__assign({ eventEnable: true, 
            /**
             * 像素宽度
             * @type {Number}
             */
             ...
             */
            supportCSSTransform: false }, cfg)) || this;
    ...
    Canvas.prototype._initPainter = function () {
        ...
        var painter = new this.cfg.renderer.painter(containerDOM, context);
    ...
    Canvas.prototype._getEventObj = function (type, e, point, target) {
        var event = new event_1.default(type, e, true, true);
        event.x = point.x;
        event.y = point.y;
    ...
    Canvas.prototype._triggerEvent = function (type, e) {
        var point = this.getPointByEvent(e);
