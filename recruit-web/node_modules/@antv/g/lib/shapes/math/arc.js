...
exports.projectPoint = exports.box = exports.pointDistance = exports.nearAngle = void 0;
...
exports.nearAngle = function (angle, startAngle, endAngle, clockwise) {
    var plus = 0;
...
exports.pointDistance = function (cx, cy, r, startAngle, endAngle, clockwise, x, y, out) {
    var v = [x, y];
    var v0 = [cx, cy];
    var v1 = [1, 0];
    var subv = Util.vec2.subtract([], v, v0);
    var angle = Util.vec2.angleTo(v1, subv);
    angle = exports.nearAngle(angle, startAngle, endAngle, clockwise);
...
exports.box = function (cx, cy, r, startAngle, endAngle, clockwise) {
    var angleRight = 0;
    var angleBottom = Math.PI / 2;
    var angleLeft = Math.PI;
    var angleTop = (Math.PI * 3) / 2;
    var points = [];
    var angle = exports.nearAngle(angleRight, startAngle, endAngle, clockwise);
    if (angle === angleRight) {
        points.push(circlePoint(cx, cy, r, angleRight));
    }
    angle = exports.nearAngle(angleBottom, startAngle, endAngle, clockwise);
    if (angle === angleBottom) {
        points.push(circlePoint(cx, cy, r, angleBottom));
    }
    angle = exports.nearAngle(angleLeft, startAngle, endAngle, clockwise);
    if (angle === angleLeft) {
        points.push(circlePoint(cx, cy, r, angleLeft));
    }
    angle = exports.nearAngle(angleTop, startAngle, endAngle, clockwise);
    if (angle === angleTop) {
    ...
    return bbox_1.default.fromRange(Math.min.apply(Math, xs), Math.min.apply(Math, ys), Math.max.apply(Math, xs), Math.max.apply(Math, ys));
};
exports.projectPoint = function (cx, cy, r, startAngle, endAngle, clockwise, x, y) {
    return exports.pointDistance(cx, cy, r, startAngle, endAngle, clockwise, x, y, true);
};
