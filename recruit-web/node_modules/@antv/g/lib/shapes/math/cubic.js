...
exports.projectPoint = exports.len = exports.extrema = exports.pointDistance = exports.derivativeAt = exports.at = void 0;
...
function pointDistance(x1, y1, x2, y2, x3, y3, x4, y4, x, y, out) {
    var t;
    var interval = 0.005;
    var d = Infinity;
    var _t;
...
function len(x1, y1, x2, y2, x3, y3, x4, y4, z) {
    if (Util.isNil(z)) {
        z = 1;
    }
    z = z > 1 ? 1 : z < 0 ? 0 : z;
...
exports.len = len;
exports.projectPoint = function (x1, y1, x2, y2, x3, y3, x4, y4, x, y) {
    return pointDistance(x1, y1, x2, y2, x3, y3, x4, y4, x, y, true);
};
